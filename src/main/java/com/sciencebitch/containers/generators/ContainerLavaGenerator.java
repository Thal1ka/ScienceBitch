...
public class ContainerLavaGenerator extends ContainerBase {
	...
	public ContainerLavaGenerator(InventoryPlayer playerInventory, TileEntityLavaGenerator tileEntity) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index != TileEntityLavaGenerator.ID_INPUTFIELD && index != TileEntityLavaGenerator.ID_CHARGEFIELD) {
				...
				} else if (TileEntityLavaGenerator.isItemFuel(stackInSlot)) {
