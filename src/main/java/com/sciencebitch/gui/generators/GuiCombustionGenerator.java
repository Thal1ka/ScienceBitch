...
public class GuiCombustionGenerator extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(ScienceBitch.MODID + ":textures/gui/container/combustion_generator.png");
	private static final int DEFAULT_FONT_COLOR = 0xffffff;

	private final InventoryPlayer playerInventory;
	private final TileEntityCombustionGenerator tileEntity;

	public GuiCombustionGenerator(InventoryPlayer playerInventory, TileEntityCombustionGenerator tileEntity) {

		super(new ContainerCombustionGenerator(playerInventory, tileEntity));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (TileEntityCombustionGenerator.isWorking(tileEntity)) {
			drawBurnBar();
		}
	}
