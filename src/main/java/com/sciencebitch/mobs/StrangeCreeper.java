...
public class StrangeCreeper extends EntityMob {
	...
	public StrangeCreeper(World worldIn) {
		super(worldIn);
	...
	public static void registerFixesCreeper(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, StrangeCreeper.class);
	}
	...
	public void onDeath(DamageSource cause) {
		...
		if (this.world.getGameRules().getBoolean("doMobLoot")) {
			...
			} else if (cause.getTrueSource() instanceof StrangeCreeper && cause.getTrueSource() != this && ((StrangeCreeper) cause.getTrueSource()).getPowered() && ((StrangeCreeper) cause.getTrueSource()).ableToCauseSkullDrop()) {
				((StrangeCreeper) cause.getTrueSource()).incrementDroppedSkulls();
