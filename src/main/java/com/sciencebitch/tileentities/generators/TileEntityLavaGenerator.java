...
public class TileEntityLavaGenerator extends TileEntityGeneratorBase {
	...
	private static final int MAX_SPEED_MULTIPLICATOR = 10;
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		...
		if (index == ID_CURRENT_ITEMFIELD)
			return false;
		if (index == ID_CHARGEFIELD)
			return TileEntityGeneratorBase.isItemChargable(stack);
